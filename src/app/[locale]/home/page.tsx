            ...
            <section className="bg-white/10 w-full md:h-[97vh] h-fit rounded-xl flex max-md:flex-col">
                <div className="flex md:flex-cols-2 max-md:flex-col md:justify-between gap-4 p-8">
                    ...
                    <div className="flex flex-col justify-start items-end gap-4">
                        <h1 className="text-3xl md:text-7xl font-bold tracking-tight text-white md:text-right text-center max-w-7xl">Share your <span className="underline decoration-3 underline-offset-4">AI</span> created videos all over the world</h1>
                    </div>
                </div>
